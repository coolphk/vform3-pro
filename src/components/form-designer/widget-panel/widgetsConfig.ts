...
export const customFields: Array<any> = []

export function addContainerWidgetSchema(containerSchema: any) {
  containers.push(containerSchema)
}

export function addBasicFieldSchema(fieldSchema: any) {
  basicFields.push(fieldSchema)
}

export function addAdvancedFieldSchema(fieldSchema: any) {
